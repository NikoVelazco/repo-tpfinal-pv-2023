 ...
 * Clase controladora para la página testimonio.html
 */
...
public class TestimonioController {
	...
	/**
	 * Inyecta e instancia el objeto testimonioService del tipo ITestimonioService al contenedor
	 * la interfaz es ITestimonioService
	 */
